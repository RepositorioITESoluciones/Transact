...
namespace Transact.Negocio
{
    public class AltaTipoTransaccionNeg
    {
        ...
        public Entidades.ReglasNegocioxAccion CatReglasNegocioxAccionN(int idTipoTransaccion, int idEtapa, int idAccion, int idEtapaF)
        {
            return AltaDatos.CatReglasNegocioxAccionD(idTipoTransaccion, idEtapa, idAccion, idEtapaF);
        }
